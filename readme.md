...
```
docker pull violafanfani/tcga-data-nf:0.0.18
```
...
You can find that at [full](execution_report_test_full.html) execution report that was obtained by running the v0.0.18
